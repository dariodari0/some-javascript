...
// Inheritance is the process of passing methods and properties from one class to another.
// In JavaScript we passed the prototype property of one constructor to another constructor.
// use Object.create instead new keyword.
...
Car.prototype.constructor = Car; // make sure that the constructor is reset for the current prototype

// 5 - Create a constructor function for a Motorcycle. Each object created from the Motorcycle function should also have 
// a make, model, and year and a property called numWheels which should be 2. The Motorcycle prototype should inherit all
// of the methods from the Vehicle prototype
...
//Recap OOP:
//Every time the 'new' keyword is used, a link between the object created and the prototype property of the constructor
// is established - this link can be accessed using __proto__
...
// To pass mergeAttributes and properties from one prototype object to another, we can use inheritance which involves setting
// the prototype property to be a newly created object using Object.create and reseting the constructor property. 
